...
class Groups(SQLModel, table=True):
    ...
    group_id: int = Field(sa_column=Column('group_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
...
class Locations(SQLModel, table=True):
    ...
    location_id: int = Field(sa_column=Column('location_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
    geo_longitude: Optional[decimal.Decimal] = Field(default=None, sa_column=Column('geo_longitude', Numeric(9, 6)))
    geo_latitude: Optional[decimal.Decimal] = Field(default=None, sa_column=Column('geo_latitude', Numeric(9, 6)))
...
class Weekdays(SQLModel, table=True):
    ...
    Available_Weekdays: list['AvailableWeekdays'] = Relationship(back_populates='Weekdays_')
...
class Users(SQLModel, table=True):
    ...
    user_id: int = Field(sa_column=Column('user_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
    ...
    location_id: Optional[int] = Field(default=None, sa_column=Column('location_id', BigInteger))

    group: Optional['Groups'] = Relationship(back_populates='Users')
    location: Optional['Locations'] = Relationship(back_populates='Users')
    Available_Weekdays: list['AvailableWeekdays'] = Relationship(back_populates='operator')
...
class AvailableWeekdays(SQLModel, table=True):
    ...
    available_weekends_id: int = Field(sa_column=Column('available_weekends_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
    weekday: str = Field(sa_column=Column('weekday', Text, nullable=False))
    operator_id: int = Field(sa_column=Column('operator_id', BigInteger, nullable=False))
...
class Offers(SQLModel, table=True):
    ...
    offer_id: int = Field(sa_column=Column('offer_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
    location_id: int = Field(sa_column=Column('location_id', BigInteger, nullable=False))
    ...
    deadline_date: datetime.date = Field(sa_column=Column('deadline_date', Date, nullable=False))
    status: str = Field(sa_column=Column('status', Text, nullable=False))
    match_id: Optional[int] = Field(default=None, sa_column=Column('match_id', BigInteger))
    format: Optional[str] = Field(default=None, sa_column=Column('format', Text))
    flight_date: Optional[datetime.date] = Field(default=None, sa_column=Column('flight_date', Date))
    operator_rating: Optional[int] = Field(default=None, sa_column=Column('operator_rating', SmallInteger))
    operator_review: Optional[str] = Field(default=None, sa_column=Column('operator_review', Text))
    client_rating: Optional[int] = Field(default=None, sa_column=Column('client_rating', SmallInteger))
    client_review: Optional[str] = Field(default=None, sa_column=Column('client_review', Text))
...
class Matches(SQLModel, table=True):
    ...
    match_id: int = Field(sa_column=Column('match_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
    operator_id: int = Field(sa_column=Column('operator_id', BigInteger, nullable=False))
...
class OfferParameters(SQLModel, table=True):
    ...
    offer_parameters_id: int = Field(sa_column=Column('offer_parameters_id', BigInteger, Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), primary_key=True))
    offer_id: int = Field(sa_column=Column('offer_id', BigInteger, nullable=False))
